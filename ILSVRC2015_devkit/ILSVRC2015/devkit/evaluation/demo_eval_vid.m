...
blacklist_file = '';
optional_cache_file = '../data/ILSVRC2015_vid_validation_ground_truth.mat';
...
[ap recall precision] = eval_vid_detection(pred_file,ground_truth_dir,meta_file,eval_file,blacklist_file,optional_cache_file);
