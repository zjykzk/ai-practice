...
- The DET test dataset will be partially refreshed with new images.
...
between the three sets.
    ...
    Dataset                  TRAIN    VALIDATION   TEST
    ------------------------------------------------------
    VID (initial release)     1952        281       458
    VID (final release TBD)  ~4000       ~500     ~1000
    ------------------------------------------------------
...
VID statistics:
  ...
  Training:
    ...
    - 1952 snippets fully annotated with the 30 object categories, yielding
      230119 manual bounding boxes for 405014 frames.

    - between 23 and 261 positive snippets per synset (median 48),

    - between 6 and 5213 frames per snippet (median 116)

  Validation:

    - 281 snippets fully annotated with the 30 object categories, yielding
      44859 manual bounding box annotations for 64698 frames.

    - between 1 and 47 snippets per category (median 7)

    - between 11 and 2898 frames per snippet (median 160)

  Test:

    - 458 snippets fully annotated with the 30 object categories.
      (these annotations will not be released)
...
The snippets collected for ILSVRC2015 are packaged as 2 folders:
